...
'''
names = open('/home/aazzolini/gdebiase/script/names4.txt')
for line in names:
    #esempio di nome contenuto in names: IZSPB_102_S26
    name = line.rstrip('\n')
    #path read concatenate
    path_concat = '/home/aazzolini/gdebiase/hs_T2Tv3/fastq_4_concat_STAR_mapping_result/' + name + '__concatUnmapped.out.mate1.gz'
    #path read forward
    path_read_F = '/home/aazzolini/gdebiase/fastp/fastq_4/' + name + '_R1_trimmed.fastq.gz'
    #path read reverse
    path_read_R = '/home/aazzolini/gdebiase/fastp/fastq_4/' + name + '_R2_trimmed.fastq.gz'
    ...
    with open('/home/aazzolini/gdebiase/sarscov2v2/fastq_4_paired/' + name + '_R1_rs.fastq', "w") as output_handle:
        SeqIO.write(outputF.values(), output_handle, "fastq")

    with open('/home/aazzolini/gdebiase/sarscov2v2/fastq_4_paired/' + name + '_R2_rs.fastq', "w") as output_handle:
